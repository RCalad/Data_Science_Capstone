...
def get_pie_chart(entered_site):
    if entered_site=='ALL':
        ...
        fig = px.pie(values=data['class'],names=data['Launch Site'],
        ...
        fig = px.pie(values=data['count'],names=data['class'],
                     title='Proportion of Success vs Failure Launches for site '+entered_site)
        fig.update_traces(textinfo='value')
        return fig
...
def get_scatter_plot(entered_site,payload_range):
    ...
    if entered_site=='ALL':
        ...
        title = 'Correlation between Payload Mass and Launch Success for '+entered_site
